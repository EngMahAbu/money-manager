...
class AccountRepository {
  ...
  Future<void> updateAccount(Account account) async {
    ...
    if (existingAccount.currency != account.currency) {
      ...
      if (hasTransactions) {
        throw Exception('Currency is locked because this account has transactions');
      }
    }
  ...
  Stream<double> watchAccountBalance(int accountId) => _dao.watchAccountBalance(accountId);
