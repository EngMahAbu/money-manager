...
import 'package:money_manager/shared/domain/repositories/category_repository.dart';
...
void main() {
  ...
  group('CategoryRepository', () {
    test('createCategory sets correct sort order', () async {
      final initialCategories = await repository
      ...
      await repository.createCategory(
        CategoriesCompanion.insert(name: 'First', type: CategoryType.expense),
      );
      await repository.createCategory(
        CategoriesCompanion.insert(name: 'Second', type: CategoryType.expense),
      );
    ...
    test('updateCategory locks type if transactions exist', () async {
      ...
      final category =
          (await repository.watchCategoriesByType(CategoryType.expense).first)
              .first;
